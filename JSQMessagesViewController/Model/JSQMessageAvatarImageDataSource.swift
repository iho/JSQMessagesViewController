...
///
/// - seealso: JSQMessagesAvatarImage
@objc public protocol JSQMessageAvatarImageDataSource: NSObjectProtocol {

    /**
     *  - Returns: The avatar image for a regular display state.
     *
    ...
    /**
     *  - Returns: The avatar image for a highlighted display state.
     *
    ...
    /**
     *  - Returns: A placeholder avatar image to be displayed if avatarImage is not yet available, or `nil`.
