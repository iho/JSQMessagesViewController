...
extension UIColor {
     ...
     */
    public static func jsq_messageBubbleGreen() -> UIColor {
     ...
     */
    public static func jsq_messageBubbleBlue() -> UIColor {
     ...
     */
    public static func jsq_messageBubbleRed() -> UIColor {
     ...
     */
    public static func jsq_messageBubbleLightGray() -> UIColor {
     ...
     */
    public func jsq_colorByDarkeningColor(withValue value: CGFloat) -> UIColor {
        var red: CGFloat = 0
        var green: CGFloat = 0
        var blue: CGFloat = 0
        var alpha: CGFloat = 0
